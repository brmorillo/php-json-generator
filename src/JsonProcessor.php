...
class JsonProcessor
{
    ...
    function generateObjectId($value)
    {
        ...
        if (is_array($value['options']['length'])) {
            ...
            $value['options']['length'] = array_values($this->replaceOthers($value['options']))[0];
        }
        ...
        return $this->generateRandomHash(round($value['options']['length']));
    }
    ...
    {
        return $this->generateFirstName() . ' ' . $this->generateSurName();
    }
    ...
    {
        return strtolower(str_replace(" ", ".", $this->generateFullName()));
    }

    function generateEmail()
    {
        return $this->generateEmailName() . "@" . $this->generateEmailDomain();
    }
