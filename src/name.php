...
class Name
{
    ...
    private function firstName(): string
    {
        ...
        return $this->util->selectItemOnArray($firstNameList);
    }
    ...
    private function surName(): string
    {
        ...
        return $this->util->selectItemOnArray($surNameList);
    }
     ...
     * @return string
     */
    private function emailName(): string
    {
        return strtolower(str_replace(" ", ".", $this->getFullName()));
    }
    ...
    private function emailDomain(): string
    {
        ...
        return $this->util->selectItemOnArray($emailDomainList);
    }
    ...
    {
        return $this->getEmailName() . '@' . $this->getEmailDomain();
    }
